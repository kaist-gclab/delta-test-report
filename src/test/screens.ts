...
export async function run() {
    ...
    const screens = [
        ...
        { url: '/asset/assets/detail', title: '에셋 상세 조회', fileName: '08' },
        { url: '/asset/assets/viewer', title: '에셋 뷰어', fileName: '09' },
        { url: '/asset/asset-types/add', title: '에셋 유형 추가', fileName: '10' },
        { url: '/asset/asset-types/list', title: '에셋 유형 목록', fileName: '11' },
        { url: '/asset/asset-types/detail', title: '에셋 유형 상세 조회', fileName: '12' },
